...
#### 1. [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) ⭐ 28,125 | 🐛 67 | 🌐 JavaScript | 📅 2026-06-23 · ⭐ 22,614
...
**Why it stands out**: ergonomic style-discovery flow, a healthy fork ecosystem (see [`frontend-slides-editable`](#9-archlizhengfrontend-slides-editable--362) below), and Anthropic itself uses the project as an example of what skills can do. The full demo video and additional assets live on the [project's README](https://github.com/zarazhangrui/frontend-slides) ⭐ 28,125 | 🐛 67 | 🌐 JavaScript | 📅 2026-06-23.

***

#### 2. [alchaincyf/huashu-design](https://github.com/alchaincyf/huashu-design) ⭐ 23,527 | 🐛 3 | 🌐 HTML | 📅 2026-08-25 · ⭐ 19,547
...
#### 3. [op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill) ⭐ 24,866 | 🐛 40 | 🌐 HTML | 📅 2026-08-07 · ⭐ 18,604
...
#### 4. [nicobailon/visual-explainer](https://github.com/nicobailon/visual-explainer) ⭐ 9,563 | 🐛 7 | 🌐 HTML | 📅 2026-08-20 · ⭐ 8,837
...
#### 5. [lewislulu/html-ppt-skill](https://github.com/lewislulu/html-ppt-skill) ⭐ 8,060 | 🐛 21 | 🌐 HTML | 📅 2026-04-26 · ⭐ 6,411
...
#### 6. [1weiho/open-slide](https://github.com/1weiho/open-slide) ⭐ 6,980 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-25 · ⭐ 5,498
...
#### 7. [zarazhangrui/beautiful-html-templates](https://github.com/zarazhangrui/beautiful-html-templates) ⭐ 4,351 | 🐛 1 | 🌐 HTML | 📅 2026-06-09 · ⭐ 3,096
...
#### 9. [archlizheng/frontend-slides-editable](https://github.com/archlizheng/frontend-slides-editable) ⭐ 466 | 🐛 4 | 🌐 HTML | 📅 2026-07-01 · ⭐ 362
...
#### 13. [Akxan/ppt-agent-skill](https://github.com/Akxan/ppt-agent-skill) ⭐ 137 | 🐛 0 | 🌐 Python | 📅 2026-05-11 · ⭐ 91
...
> Agent-agnostic PPT design skills for generating polished PowerPoint decks with [ppt-master](https://github.com/hugohe3/ppt-master) ⭐ 49,313 | 🐛 7 | 🌐 Python | 📅 2026-08-25.
...
#### T1. [zarazhangrui/beautiful-html-templates](https://github.com/zarazhangrui/beautiful-html-templates) ⭐ 4,351 | 🐛 1 | 🌐 HTML | 📅 2026-06-09 · ⭐ 3,096
...
If you find a broken link, a stale star count, or a project we missed, [open an issue](https://github.com/ToseaAI/awesome-html-slide-skills/issues/new) ⭐ 128 | 🐛 0 | 📅 2026-06-23.
...
Inline preview images are hot-linked from each project's own GitHub repository (under `raw.githubusercontent.com` or `github.com/user-attachments`). They remain the copyright of their respective authors and are shown here as fair-use thumbnails to help readers identify each project at a glance. If you are the author of a project featured here and would like a preview removed or swapped, [open an issue](https://github.com/ToseaAI/awesome-html-slide-skills/issues/new) ⭐ 128 | 🐛 0 | 📅 2026-06-23 and we'll fix it immediately.
